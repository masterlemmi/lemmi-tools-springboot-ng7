...
public class PeopleQuickstart {
    ...
    private static final String CREDENTIALS_FILE_PATH = "C:/Users/IF58/client_scret.json";
    ...
    public static void smain(String... args) throws IOException, GeneralSecurityException {
